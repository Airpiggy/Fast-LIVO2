...
if("TRUE" STREQUAL "TRUE")
  set(realsense2_camera_SOURCE_PREFIX /home/airpig/fast-livo2/src/realsense-ros/realsense2_camera)
  set(realsense2_camera_DEVEL_PREFIX /home/airpig/fast-livo2/devel)
  ...
  set(realsense2_camera_INSTALL_PREFIX /home/airpig/fast-livo2/install)
...
if(NOT "/home/airpig/fast-livo2/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'realsense2_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/airpig/fast-livo2/src/realsense-ros/realsense2_camera/${idir}'.  ${_report}")
    endif()
